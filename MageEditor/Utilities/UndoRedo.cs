...
namespace MageEditor.Utilities
{
    ...
    public class UndoRedo
    {
        ...
        public ReadOnlyObservableCollection<IUndoRedo> RedoList { get; } // displayed from last to first element/item
        public ReadOnlyObservableCollection<IUndoRedo> UndoList { get; } // displayed from first to last element/item
