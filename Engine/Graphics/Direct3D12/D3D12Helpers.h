...
// helpers inspired by https://github.com/microsoft/DirectX-Graphics-Samples/blob/master/Libraries/D3D12RaytracingFallback/Include/d3dx12.h
...
namespace mage::gfx::d3d12::d3dx {
    ...
    struct d3d12_descriptor_range : public D3D12_DESCRIPTOR_RANGE1 {
        constexpr explicit d3d12_descriptor_range(D3D12_DESCRIPTOR_RANGE_TYPE range_type,
                                                  u32 descriptor_count, u32 shader_register, u32 register_space = 0,
    ...
    struct d3d12_root_parameter : public D3D12_ROOT_PARAMETER1 {
        constexpr void as_constant(u32 num_constants, D3D12_SHADER_VISIBILITY visibility,
    ...
    private:
        constexpr void as_descriptor(D3D12_ROOT_PARAMETER_TYPE type, D3D12_SHADER_VISIBILITY visibility,
                                     u32 shader_register, u32 register_space, D3D12_ROOT_DESCRIPTOR_FLAGS flags) {
            ParameterType = type;
            ShaderVisibility = visibility;
    ...
    /// <summary>
    /// Maximum 64 DWORDs (u32's) divided up amongst all root parameters. <para/>
    /// Root constants = 1 DWORD per 32-bit constant <para/>
    /// Root descriptor (CBV, SRV or UAV) = 2 DWORDs each <para/>
    /// Descriptor table pointer = 1 DWORD <para/>
