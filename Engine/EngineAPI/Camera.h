...
public:
    ...
    constexpr camera_id get_id() { return _id; }
    ...
    math::mat4x4 view() const;
    math::mat4x4 projection() const;
    math::mat4x4 inverse_projection() const;
    math::mat4x4 view_projection() const;
    math::mat4x4 inverse_view_projection() const;
